 ...
 * @title 密码类
 */
namespace normphpCore\encryption\password;
...
class PasswordHash
{
     ...
     */
    public function password_hash(string $password, $algo = PASSWORD_BCRYPT,array $options=['cost'=>10] )
    {
     ...
     *
     */
    public function password_verify(string $password,string $hash, $algo=PASSWORD_BCRYPT,array $options=[])
    {
        ...
        return ['result'=>false,'newHash'=>false];
